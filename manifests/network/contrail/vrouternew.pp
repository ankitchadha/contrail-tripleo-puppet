...
#
class tripleo::network::contrail::vrouternew (
  $step               = hiera('step'),
  ...
  $control_server     = hiera('contrail_control_new_node_ips'),
  $disc_server_ip     = hiera('contrail::confignew::host_ip'),
  $disc_server_port   = hiera('contrail::disc_server_port'),
  $gateway            = hiera('contrail::vrouternew::gateway'),
  $host_ip            = hiera('contrail::vrouternew::host_ip'),
  $insecure           = hiera('contrail::insecure'),
  $memcached_servers  = hiera('contrail::memcached_server'),
  $metadata_secret    = hiera('contrail::vrouternew::metadata_proxy_shared_secret'),
  $netmask            = hiera('contrail::vrouternew::netmask'),
  $physical_interface = hiera('contrail::vrouternew::physical_interface'),
  $public_vip         = hiera('public_virtual_ip'),
  $is_tsn             = hiera('contrail::vrouternew::is_tsn',false),
) {
