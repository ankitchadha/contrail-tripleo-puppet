...
#
class tripleo::network::contrail::analyticsnew(
  $step                       = hiera('step'),
  ...
  $cassandra_server_list      = hiera('contrail_analytics_database_new_node_ips'),
  ...
  $kafka_broker_list          = hiera('contrail_analytics_database_new_node_ips'),
  ...
  $rest_api_port              = hiera('contrail::analyticsnew::rest_api_port'),
